...
function Training() {
  return (
    <Container className="project-section" style={{ textAlign: "left" }} >
      ...
      <p style={{ color: "#e0e0e0" }}>
        I have also build <strong>False Alarm Detector</strong> app, which detects false alarms in real-time conversations by analyzing content and sending alerts to the admin authorities when necessary.
      </p>
